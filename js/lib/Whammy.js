	...
	return {
		...
		fromImageArray: function(images, fps, outputAsArray){
			images = images.map(function(image){
				try {
					var slice = image.slice(image.indexOf("base64,") + 7);
					console.log(image);
					console.log(slice);
					var sliceatob = atob(slice);
					var riff = parseRIFF(sliceatob);
					var webp = parseWebP(riff);
			...
			return toWebM(new_images, outputAsArray);
		},
		toWebM: toWebM
